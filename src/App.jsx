...
const LinkTree = () => {
  ...
  const links = useMemo(() => [
    ...
    { id: 2, icon: <SiLeetcode />, text: 'Leetcode', url: 'https://leetcode.com/u/Rajse/' },
    { id: 3, icon: <FiLinkedin />, text: 'LinkedIn', url: 'https://www.linkedin.com/in/raj-sharma-23447527b?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app ' },
    { id: 4, icon: <TbBrandHackerrank />, text: 'HackerRank', url: 'https://www.hackerrank.com/profile/rjsharmase' },
    { id: 5, icon: <FiInstagram />, text: 'Instagram', url: 'https://www.instagram.com/raj_s.e?igsh=YjZqZmVsd3kwNWsx' },
    { id: 6, icon: <FaWhatsapp />, text: 'Whatsapp', url: 'https://wa.me/918360206237' },
    { id: 7, icon: <FiMail />, text: 'Contact', url: 'mailto:rjsharmase@gmail.com' },
  ], []);
  ...
  // Optimized particles config
  const particlesOptions = useMemo(() => ({
    particles: {
      number: { value: 30 }, // Reduced from 50
      move: { 
        enable: true, 
  ...
  return (
    <div className={`min-h-screen ${isDark ? 'bg-slate-900' : 'bg-slate-100'} transition-colors duration-500`}>
      ...
      <div className="fixed inset-0 bg-[linear-gradient(to_right,#00ff8833_1px,transparent_1px),linear-gradient(to_bottom,#00ff8833_1px,transparent_1px)] bg-[size:24px_24px] opacity-10" />
